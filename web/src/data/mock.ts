...
export const mockCourses = [
  ...
  { id: 4, title: 'Đàn nguyệt và điệu hát cổ', instrument: 'Đàn nguyệt', level: 'Beginner', progress: 0, lessons: 8, duration: '2 giờ 15 phút', color: '#e5a05f' },
];

...
export function InstrumentFeatures() {
  return <section className="instrument-features" aria-label="Tìm nhạc cụ dành cho bạn">
    <header>
      <span className="section-kicker"><Sparkles size={14} /> Tìm thanh âm của bạn</span>
      <h2 className="features-script-title">
        <span className="script-title-green">Mỗi nhạc cụ,</span>{' '}
        <span className="script-title-orange">một khởi đầu</span>
      </h2>
    </header>

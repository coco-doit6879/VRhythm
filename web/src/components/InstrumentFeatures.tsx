...
export function InstrumentFeatures() {
  return <section className="instrument-features" aria-label="Tìm nhạc cụ dành cho bạn">
    <header><span className="section-kicker"><Sparkles size={14} /> Tìm thanh âm của bạn</span><h2>Mỗi nhạc cụ, một khởi đầu.</h2></header>
